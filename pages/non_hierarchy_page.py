# pages/non_hierarchy_page.py
import os
import time
from playwright.sync_api import Page

class NonHierarchyPage:
    def __init__(self, page: Page):
        self.page = page
        self.btn_get_started = page.get_by_role("button", name="Get Started")
        self.btn_nonhierarchy_pr = page.get_by_role("button", name="Non-hierarchy PR").first
        self.btn_apply = page.get_by_role("button", name="Apply")
        self.btn_upload_nonhierarchy = page.get_by_role("button", name="+ Upload Non Hierarchy Data")
        ...
        self.txt_search = page.get_by_role("textbox", name="Search")
    ...
    def create_nonhierarchy_pr(self, indexes: list):
        """Complete the Non-hierarchy PR setup."""
        self.btn_get_started.click()
        self.page.wait_for_timeout(2000)

        self.btn_nonhierarchy_pr.click()
        self.page.wait_for_timeout(2000)
    ...
    def create_jurisdiction_pr(self, indexes):
        ...
        self.btn_upload_nonhierarchy.wait_for(state="visible")  
        self.btn_upload_nonhierarchy.click()
        self.page.wait_for_timeout(500)
        ...
        upload_file_path = os.path.join("uploads", "nonhierarchy", "ProblemBolo_jurisdiction.csv")
    ...
    def create_geofence(self):
        upload_file_path1 = os.path.join("uploads", "nonhierarchy", "Hyderabad.kml")
    ...
    def create_roles(self):
        upload_file_path1 = os.path.join("uploads", "nonhierarchy", "ProblemBolo_Role_Details_non_hierarchy.csv")
    ...
    def create_personnel(self):
        upload_file_path1 = os.path.join("uploads", "nonhierarchy", "ProblemBolo_personnel_non_hierarchy.csv")
    ...
    def create_fullnonhierarchy_pr(self,indexes):
    ...
    def search_nonhierarchy(self, search_term: str):
        ...
        self.txt_search.fill(search_term)
        self.page.wait_for_timeout(2000)
